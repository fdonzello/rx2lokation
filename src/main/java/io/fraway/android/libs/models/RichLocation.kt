 ...
 */
data class RichLocation(val lat: Double, val lng: Double, val address: String?, val city: String?, val postalCode: String?, val countryCode: String?, val province: String?) {
    ...
    companion object {
        fun fromAddress(address: Address): RichLocation {
            ...
            return RichLocation(address.latitude, address.longitude, addressName, city, postalCode, countryCode, address.subAdminArea).apply {
